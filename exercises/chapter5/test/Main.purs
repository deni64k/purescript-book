...
import ChapterExamples (Amp(..), Volt(..), current, fromString, gcd, gcdV2, isEmpty, lzs, partialFunction, showPerson, showPersonV2, sortPair, takeFive, toString, unknownPerson)
